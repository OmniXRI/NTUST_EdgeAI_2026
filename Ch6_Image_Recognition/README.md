...
* 範例6-3:yolov26-object-detection-openvino-ir.ipynb  
  * [使用 OpenVINO™ 轉換 YOLO26 模型成 IR 格式並進行物件偵測推論](https://colab.research.google.com/github/OmniXRI/NTUST_EdgeAI_2026/blob/main/Ch6_Image_Recognition/yolov26-object-detection-openvino-ir.ipynb)  
